...
<template>
  <header class="flex justify-between items-center bg-main-green border-transparent sticky top-0 z-[60] px-6 py-8 max-h-[92px]">
    ...
    <div class="flex items-center justify-evenly">
      <label for="switch" :class="{'font-bold': !listStore.isInShopView}">To buy</label>
      <label class="relative inline-flex cursor-pointer items-center mx-2">
        ...
        <label for="switch" class="hidden"></label>
          <div class="peer h-6 w-11 rounded-full border bg-main-green after:absolute after:left-[2px] after:top-0.5 
            after:h-5 after:w-5 after:rounded-full after:border after:border-gray-400 after:bg-main-gray 
            after:checked:bg-main-green after:transition-all after:content-[''] peer-checked:bg-main-gray 
            peer-checked:after:translate-x-full peer-checked:after:bg-main-green peer-checked:after:border-white
            peer-focus:ring-gray-400">
          </div>
        </label>
      <label for="switch" :class="{'font-bold': listStore.isInShopView}">In Shop</label>
    </div>
